        ...
        <Reveal delay={400} direction="up">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6">
            <Link
              ...
              className="group w-full sm:w-auto max-w-[280px] sm:max-w-none mx-auto sm:mx-0 px-6 py-3.5 sm:px-8 sm:py-4.5 rounded-full bg-blue-600 text-white font-bold text-base sm:text-lg transition-all active:scale-95 shadow-[0_0_30px_rgba(37,99,235,0.4)] hover:shadow-[0_0_40px_rgba(37,99,235,0.6)] flex items-center justify-center gap-2"
            >
            ...
            <Link
              ...
              className="w-full sm:w-auto max-w-[280px] sm:max-w-none mx-auto sm:mx-0 px-6 py-3.5 sm:px-8 sm:py-4.5 rounded-full bg-black/40 border border-white/10 hover:bg-white/10 text-white font-bold text-base sm:text-lg transition-all active:scale-95 flex items-center justify-center gap-2 backdrop-blur-sm"
            >
