...
export function MobileFab() {
  ...
  return (
    <div
      className={cn(
        'lg:hidden fixed bottom-[calc(1.25rem+env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 z-50 w-[88%] max-w-[320px] transition-[opacity,transform] duration-300 ease-out motion-reduce:transition-none motion-reduce:duration-0',
    ...
    >
      <Link
        ...
        className="w-full flex items-center justify-center gap-2 bg-orange border-2 border-navy text-white font-bold py-3 px-5 text-sm shadow-brutal-sm active:scale-95 motion-reduce:active:scale-100 transition-transform motion-reduce:transition-none focus:outline-none focus-visible:ring-2 focus-visible:ring-white"
      >
        Audit gratuit
