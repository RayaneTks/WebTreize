...
export const REALISATIONS: readonly Realisation[] = [
  ...
  },
  {
    ...
    alt: 'L’écran de caisse d’Encore1Dessert sur téléphone : recherche produit, panier, liste des tartes et total avec la marge.',
  ...
  },
  {
    ...
    alt: 'La page d’accueil du QCM Fluides frigorigènes, avec le titre de l’outil et l’accès aux séries de questions.',
